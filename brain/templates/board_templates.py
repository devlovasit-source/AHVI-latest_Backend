    ...
    # =========================
    {
        ...
        "roles": [
            ...
            },
            {
                "id": "earrings",
                "required": False,
                "keywords": ["earrings", "studs", "hoops", "chandbali"],
            },
            {
                "id": "bracelet",
                "required": False,
                "keywords": ["bracelet", "bangle", "kada"],
            },
    ...
    # ======================
    {
        ...
        "roles": [
            ...
            },
            {
                "id": "shoes",
                "required": True,
                "keywords": ["heels", "flats", "sandals", "slides"],
            },
            {
                "id": "bag",
                "required": True,
                "keywords": ["clutch", "shoulder", "crossbody", "tote", "mini"],
            },
            {
                "id": "earrings",
                "required": False,
            ...
            },
            {
                "id": "necklace",
                "required": False,
                "keywords": ["necklace", "pendant", "choker"],
            },
            {
                "id": "sunglasses",
                "required": False,
        ...
        "roles": [
            {
                "id": "outfit",
                "required": True,
                "keywords": ["lehenga", "saree", "kurta", "gown", "sherwani"],
            },
            {
                "id": "shoes",
                "required": True,
                "keywords": ["heels", "juttis", "sandals"],
            },
            {"id": "bag", "required": True, "keywords": ["clutch", "potli", "mini"]},
            {
                "id": "earrings",
                "required": True,
                "keywords": ["earrings", "jhumka", "chandbali"],
            },
