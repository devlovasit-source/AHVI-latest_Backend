    ...
    "wardrobe_tag_normalizer_v1": {
        ...
        "output_schema": {
            "wardrobe_index_item": {
                ...
                "gender_scope": {
                    "type": "enum",
                    "allowed": ["woman", "man", "unisex", "unknown"],
                },
                ...
                "finish": {
                    "type": "enum",
                    "allowed": ["matte", "glossy", "textured", "metallic", "unknown"],
                },
                "formality": {
                    "type": "enum",
                    "allowed": [
        ...
        "slot_rules": {
            ...
            "special_slot_overrides": [
                ...
                {"if_subcategory_in": ["belt"], "add_slots": ["waist_definition"]},
            ],
        },
        "color_normalization": {
            "primary_color_priority": [
                "black",
                "white",
                "cream",
                "beige",
        ...
        "formality_inference": {
            "rules": [
                {
                    "if_any": {
                        "subcategory_in": ["blazer", "trousers", "loafer"],
                        "pattern_not": ["animal"],
                    },
                ...
                {"fallback": true, "set_formality": "unknown"},
            ]
        },
        "season_inference": {
            "season_tags": [
        ...
        "style_tag_inference": {
            "rules": [
                ...
                {
                    "if_category_group_is": "indian_wear",
                    "add": ["ethnic_traditional", "fusion"],
                },
            ],
            "notes": [
        ...
        "fit_tag_inference": {
            "rules": [
                ...
                {
                    "if_title_contains_any": ["high waist", "high-waist"],
                    "add": ["high_waist"],
                },
            ],
            "defaults": [],
        ...
        "occasion_place_inference": {
            ...
            "rules": [
                {
                    "if_subcategory_in": ["blazer", "trousers", "loafer"],
                    "add_occasion": ["work_day", "meeting_day"],
                    "add_place": ["office"],
                },
                {
                    "if_subcategory_in": ["clutch"],
                    "add_occasion": ["party_night_out", "wedding_guest"],
                    "add_place": ["club_night", "wedding_venue"],
                },
                {
                    "if_subcategory_in": ["sneaker", "backpack"],
                    "add_occasion": ["airport_travel", "shopping_day"],
                    "add_place": ["airport", "mall_shopping"],
                },
                {
                    "if_category_group_is": "indian_wear",
                    "add_occasion": ["festive_ethnic", "wedding_guest"],
                    "add_place": ["home_hosting", "wedding_venue", "temple_religious"],
                },
            ],
        },
        ...
        "compatibility_scoring": {
            ...
            "score_range": [0, 1],
            "thresholds": {"strong_match": 0.7, "okay_match": 0.45, "weak_match": 0.25},
        },
        "dev_notes": [
