...
def bootstrap() -> None:
    ...
    _create_float("temperature_min_c")
    _create_float("temperature_max_c")
    _create_string("fabric_weight", 16)
    _create_float("layering_suitability")
    _create_boolean("rain_suitable")
    _create_boolean("wind_suitable")
