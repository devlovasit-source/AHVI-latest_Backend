...
_COURT_SPORT_FALLBACKS: List[Dict[str, Any]] = [
    {
        ...
        "description": "A breathable performance tee and court-ready base keep the court look light and mobile.",
...
def _build_response(
    *,
    ...
    response = {
        ...
        "daypart": (context or {}).get("daypart"),
...
def reason(
    ...
    if mode == WARDROBE_STYLE:
        return {
            ...
            "daypart": safe_context.get("daypart"),
