...
try:
    from routers.wardrobe_interactions import router as wardrobe_interactions_router
    app.include_router(wardrobe_interactions_router)
except Exception as exc:
    logger.warning("Failed to load wardrobe_interactions_router: %s", str(exc)[:140])
